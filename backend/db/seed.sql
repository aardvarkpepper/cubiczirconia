...
VALUES
(true, 'Courage Badge', 'Courage!', 'local', '/images/courage_badge.png', 'https://example.com/courage_badge.png'),
(true, 'Sonic Badge', 'Gotta go fast!', 'url', '/images/sonic_badge.jpg', 'https://example.com/sonic_badge.jpg'),
(true, 'Wile E. Coyote Badge', 'I am a genius by trade.', 'local', '/images/coyote_badge.png', 'https://example.com/coyote_badge.png'),
(true, 'Luffy Badge', 'Aren''t we friends?', 'url', '/images/luffy_badge.jpg', 'https://example.com/luffy_badge.jpg');
